//! Rendering for execute responses: engine events, item-result groups, and
//! script output.

use crate::diff;
use crate::syndiff::SmaliSnippetKind;
use crate::types::{EngineEvent, EngineResult, engine_event, engine_result};
use itertools::Itertools;
use std::fmt::Write as _;

use super::formatters::Formatter;
use super::helpers::{
    class_change_kind_label, indented_block, method_change_kind_label, resource_change_kind_label,
};
use super::render::{RenderOutput, stderr_only, stdout_only};
use super::style;

pub(super) fn render_execution_result(events: &[EngineEvent], fmt: &dyn Formatter) -> RenderOutput {
...
fn render_fingerprint_matches(
    ...
    for method in &payload.methods {
        if is_md {
            ...
            output.push_stdout(format!(
                "    {}\n",
                super::formatters::human_method_id(
